...
class RoBERTaAsEmbeddingsModel(EmbeddingsModel):
    def __init__(self, languages: XLMRLanguages, path: str) -> None:
        super().__init__([languages])
        self.model: RobertaModel = RobertaModel.from_pretrained(path)
        self.tokenizer: RobertaTokenizer = RobertaTokenizer.from_pretrained(path)
